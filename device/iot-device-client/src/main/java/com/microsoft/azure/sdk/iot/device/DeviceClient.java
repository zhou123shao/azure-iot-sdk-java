...
public final class DeviceClient implements Closeable
{
     ...
     *
     * @param blobName is a string with the name of the file in the storage.
     ...
     */
    public void uploadToBlobAsync(String blobName, InputStream inputStream, long streamLength,
                                  IotHubEventCallback callback,
                                  Object callbackContext)
            throws IllegalArgumentException, IOException
    {
        /* Codes_SRS_DEVICECLIENT_21_044: [The uploadToBlobAsync shall asynchronously upload the stream in `inputStream` to the blob in `blobName`.] */
        ...
        /* Codes_SRS_DEVICECLIENT_21_047: [If the `blobName` is null, empty or not valid, the uploadToBlobAsync shall throw IllegalArgumentException.] */
        ...
        this.fileUpload.uploadToBlobAsync(blobName, inputStream, streamLength, callback, callbackContext);
    }
