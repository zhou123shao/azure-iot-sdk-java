...
public class FileUploadTaskTest
{
    ...
    @Mocked
    private Message mockMessageRequest;

    @Mocked
    private Message mockMessageNotification;
    ...
    public void runCreateNotification() throws IOException, IllegalArgumentException, URISyntaxException, StorageException
    {
        ...
        {
            {
                new Message(VALID_NOTIFICATION_JSON);
                times = 1;
            }
        };
    }
    ...
    /* Tests_SRS_FILEUPLOADTASK_21_031: [If run failed to send the request, it shall call the userCallback with the stratus `ERROR`, and abort the upload.] */
    @Test
        ...
        {
            {
                ...
                new Message(VALID_REQUEST_JSON);
                result = new IllegalArgumentException();
            }
        };
    ...
    /* Tests_SRS_FILEUPLOADTASK_21_031: [If run failed to send the request, it shall call the userCallback with the stratus `ERROR`, and abort the upload.] */
    @Test
    public void runOpenTransportForRequestThrows() throws IOException, IllegalArgumentException, URISyntaxException, StorageException
    {
        // arrange
        new NonStrictExpectations()
        {
    ...
    /* Tests_SRS_FILEUPLOADTASK_21_031: [If run failed to send the request, it shall call the userCallback with the stratus `ERROR`, and abort the upload.] */
    @Test
    public void runCloseTransportForRequestThrows() throws IOException, IllegalArgumentException, URISyntaxException, StorageException
    {
        // arrange
        new NonStrictExpectations()
        {
            {
                ...
                mockHttpsTransportManager.send(mockMessageRequest);
                result = mockResponseMessage;
                mockHttpsTransportManager.close();
                result = new IOException();
            }
        };
        ...
        {
            {
                mockResponseMessage.getStatus();
                times = 1;
                mockIotHubEventCallback.execute(IotHubStatusCode.BAD_FORMAT, VALID_CALLBACK_CONTEXT);
                times = 1;
            }
        };
    }
