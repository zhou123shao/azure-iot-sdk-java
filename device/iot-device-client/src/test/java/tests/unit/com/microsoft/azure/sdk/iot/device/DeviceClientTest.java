...
public class DeviceClientTest
{
    ...
    */
    ...
    /* Tests_SRS_DEVICECLIENT_21_044: [The uploadToBlobAsync shall asynchronously upload the stream in `inputStream` to the blob in `blobName`.] */
                                        ...
                                        @Mocked final PropertyCallBack mockedPropertyCB) throws IOException, URISyntaxException
    {
        ...
        final String connString = "HostName=iothub.device.com;CredentialType=SharedAccessKey;DeviceId=testdevice;"
                + "SharedAccessKey=adjkl234j52=";
        final IotHubClientProtocol protocol = IotHubClientProtocol.AMQPS;
        final String blobName = "valid/blob/name.txt";
        ...
        {
            {
                ...
                Deencapsulation.invoke(mockedFileUpload, "uploadToBlobAsync",
                        blobName, mockInputStream, streamLength, mockedStatusCB, mockedPropertyCB);
            }
        };
        DeviceClient client = new DeviceClient(connString, protocol);

        // act
        client.uploadToBlobAsync(blobName, mockInputStream, streamLength, mockedStatusCB, mockedPropertyCB);
                                                  ...
                                                  @Mocked final PropertyCallBack mockedPropertyCB) throws IOException, URISyntaxException
    {
        ...
        // act
        client.uploadToBlobAsync(blobName, mockInputStream, streamLength, null, mockedPropertyCB);
    }
                                                     ...
                                                     @Mocked final PropertyCallBack mockedPropertyCB) throws IOException, URISyntaxException
    {
        ...
        // act
        client.uploadToBlobAsync(blobName, (InputStream) null, streamLength, mockedStatusCB, mockedPropertyCB);
    }
                                                     ...
                                                     @Mocked final PropertyCallBack mockedPropertyCB) throws IOException, URISyntaxException
    {
        ...
        // act
        client.uploadToBlobAsync(blobName, mockInputStream, -1, mockedStatusCB, mockedPropertyCB);
    }

    /* Tests_SRS_DEVICECLIENT_21_047: [If the `blobName` is null, empty, or not valid, the uploadToBlobAsync shall throw IllegalArgumentException.] */
    @Test (expected = IllegalArgumentException.class)
                                                         ...
                                                         @Mocked final PropertyCallBack mockedPropertyCB) throws IOException, URISyntaxException
    {
        ...
        final String connString = "HostName=iothub.device.com;CredentialType=SharedAccessKey;DeviceId=testdevice;"
                + "SharedAccessKey=adjkl234j52=";
        final IotHubClientProtocol protocol = IotHubClientProtocol.AMQPS;
        final String blobName = "valid\u1234/blob/name.txt";
        final long streamLength = 100;
                                                        ...
                                                        @Mocked final PropertyCallBack mockedPropertyCB) throws IOException, URISyntaxException
    {
        ...
        final String blobName = bigBlobName.toString();
