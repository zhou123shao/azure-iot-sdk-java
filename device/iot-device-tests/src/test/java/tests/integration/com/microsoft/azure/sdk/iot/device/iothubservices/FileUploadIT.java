...
import static tests.integration.com.microsoft.azure.sdk.iot.device.iothubservices.FileUploadIT.STATUS.FAILURE;
import static tests.integration.com.microsoft.azure.sdk.iot.device.iothubservices.FileUploadIT.STATUS.SUCCESS;
...
public class FileUploadIT
{
    ...
    private void verifyNotification(FileUploadNotification fileUploadNotification, FileUploadState fileUploadState) throws IOException, URISyntaxException
    {
        ...
        try (InputStream inputStream = u.openStream())
        {
            ...
            int actualLen = fileUploadState.fileInputStream.read(actualBuf, 0, (int) fileUploadState.fileLength);
