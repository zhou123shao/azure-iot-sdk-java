...
public class ReceiveMessagesCommon extends IntegrationTest
{
    ...
    public class ReceiveMessagesTestInstance
    {
        ...
        {
            ReceiveMessagesTestInstance newInstance = new ReceiveMessagesTestInstance(protocol, authenticationType, clientType, publicKeyCert, privateKey, x509Thumbprint);
