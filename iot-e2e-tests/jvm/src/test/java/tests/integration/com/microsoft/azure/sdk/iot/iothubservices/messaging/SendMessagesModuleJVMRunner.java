...
public class SendMessagesModuleJVMRunner extends SendMessagesTests
{
    ...
    public SendMessagesModuleJVMRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
