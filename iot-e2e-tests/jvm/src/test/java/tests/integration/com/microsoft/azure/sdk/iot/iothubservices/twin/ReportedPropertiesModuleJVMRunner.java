...
{
    public ReportedPropertiesModuleJVMRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
    ...
    public static Collection inputs() throws Exception
    {
        ...
        return DeviceTwinCommon.inputsCommon(ClientType.MODULE_CLIENT);
    }
}
