...
public class DeviceMethodErrInjDeviceJVMRunner extends DeviceMethodErrInjTests
{
    ...
    public DeviceMethodErrInjDeviceJVMRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
