...
public class ReceiveMessagesErrInjDeviceJVMRunner extends ReceiveMessagesErrInjTests
{
    ...
    public ReceiveMessagesErrInjDeviceJVMRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
