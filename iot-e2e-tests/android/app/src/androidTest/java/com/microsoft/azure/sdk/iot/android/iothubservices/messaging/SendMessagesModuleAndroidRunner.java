...
public class SendMessagesModuleAndroidRunner extends SendMessagesTests
{
    ...
    public SendMessagesModuleAndroidRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint) throws Exception
    {
