...
public class DeviceMethodModuleAndroidRunner extends DeviceMethodTests
{
    ...
    public DeviceMethodModuleAndroidRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint) throws Exception
    {
