...
cmd = "adb -s "+sys.argv[1]+" shell am instrument -w -r -e debug false -e "+sys.argv[2]+" "+sys.argv[3]+" com.iothub.azure.microsoft.com.androide2e.test/android.support.test.runner.AndroidJUnitRunner"
print(cmd)
